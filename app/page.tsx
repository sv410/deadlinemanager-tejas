        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="font-heading text-4xl md:text-5xl font-bold mb-5 text-white">
                Have Questions? Contact Us
              </h2>
              <p className="text-lg md:text-xl text-gray-400">We're here to help you make the most of DeadlineSync</p>
            </div>

            <div className="bg-zinc-900 border border-orange-500/20 p-8 md:p-12 rounded-3xl shadow-xl shadow-orange-500/10">
              <ContactForm />
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-400 mb-8">
              Subscribe to our newsletter for deadline management tips, feature updates, and productivity hacks
            </p>
            <NewsletterForm />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-6">
              ...
              <Link href="#testimonials" className="text-sm text-gray-400 hover:text-orange-500 transition-colors">
                Testimonials
              </Link>
